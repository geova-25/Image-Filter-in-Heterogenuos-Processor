...
module interconexion_mm_interconnect_0 (
	...
	wire  [124:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> jtag_uart_0_avalon_jtag_slave_burst_adapter:sink0_data
	...
	wire  [124:0] cmd_demux_002_src1_data;                                                    // cmd_demux_002:src1_data -> cmd_mux_002:sink0_data
	...
	wire  [124:0] cmd_demux_003_src1_data;                                                    // cmd_demux_003:src1_data -> cmd_mux_002:sink1_data
	wire          cmd_demux_003_src1_ready;                                                   // cmd_mux_002:sink1_ready -> cmd_demux_003:src1_ready
	wire    [3:0] cmd_demux_003_src1_channel;                                                 // cmd_demux_003:src1_channel -> cmd_mux_002:sink1_channel
	...
	wire  [124:0] rsp_demux_002_src0_data;                                                    // rsp_demux_002:src0_data -> rsp_mux_002:sink1_data
	...
	wire  [124:0] rsp_demux_002_src1_data;                                                    // rsp_demux_002:src1_data -> rsp_mux_003:sink1_data
	wire          rsp_demux_002_src1_ready;                                                   // rsp_mux_003:sink1_ready -> rsp_demux_002:src1_ready
	wire    [3:0] rsp_demux_002_src1_channel;                                                 // rsp_demux_002:src1_channel -> rsp_mux_003:sink1_channel
	...
	interconexion_mm_interconnect_0_router router_001 (
	...
	interconexion_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	interconexion_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	interconexion_mm_interconnect_0_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	interconexion_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
